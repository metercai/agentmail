...
| 角色 | 默认权限 |
|------|---------|
| **orchestrator** | create, assign, review, block, unblock, cancel, reassign, edit, deadline, output, notify, members, config, arbitrate, comment, list, show, heartbeat, gateway_info |
